              ...
              <table class="table table-bordered review-table">
                ...
                <tr>
                  ...
                  <td>
                    <ul style="list-style-type: none;">
                      <li>
                		@if ($AppPersonal[0]->sex == 'F')
		                	女
        		        @else
                			男
		                @endif
        		        </li>
                		<li>{{ $AppPersonal[0]->age }}</li>
		                <li>{{ $AppPersonal[0]->birthday }}</li>
        		        <li>{{ $AppPersonal[0]->postal_code }}&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;{{ $AppPersonal[0]->prefecture }}&nbsp;&nbsp;&nbsp; -&nbsp;&nbsp;&nbsp; {{ $AppPersonal[0]->address }}</li>
                		<li>{{ $AppPersonal[0]->telephone }}</li>
		                <li>{{ $AppPersonal[0]->work_place_name }}</li>
		                <li>{{ $AppPersonal[0]->work_place_pref }} - {{ $AppPersonal[0]->work_place_address }}</li>
        		        <li>{{ $AppPersonal[0]->work_place_tel }}</li>
                		<li>{{ $AppPersonal[0]->kinzoku_y }}年 - {{ $AppPersonal[0]->kinzoku_m }}ヶ月</li>
		                <li><?php echo (float)$AppPersonal[0]->nenshu;?>万円</li>
